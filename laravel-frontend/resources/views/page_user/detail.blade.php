            ...
            <div class="detail-info">
                ...
                <div class="detail-action__benefits" style="margin-bottom: 2rem; font-size: 0.875rem;">
                    ...
                    <div style="display: flex; margin-bottom: 1rem; align-items: center;">
                        ...
                        <div style="display: flex; border: 1px solid rgba(0,0,0,.09); border-radius: 2px;">
                            ...
                            <input type="text" id="qty-input" value="1" data-max="{{ $sanPham->so_luong_ton }}" style="width: 50px; height: 32px; text-align: center; border: none; font-size: 1rem; outline: none;">
                        ...
                        <span style="color: #767676; margin-left: 1rem;">{{ $sanPham->so_luong_ton }} sản phẩm có sẵn</span>
                    </div>
                </div>
