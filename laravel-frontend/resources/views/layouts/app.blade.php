    ...
    <header class="bg-gray-200 py-4 px-8 sticky top-0 z-50 shadow-sm">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <nav class="hidden md:flex space-x-8">
                <a href="/product" class="text-gray-700 font-bold hover:text-pink-500 transition">Sản phẩm</a>
                <a href="/sale" class="text-gray-700 font-bold hover:text-pink-500 transition">Khuyến mãi</a>
                <a href="/bestseller" class="text-gray-700 font-bold hover:text-pink-500 transition">Bán chạy</a>
            </nav>
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="flex items-center space-x-4 text-gray-700">
                    <a href="/cart" class="hover:text-pink-500 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                        </svg>
                    </a>
                    <a href="/profileuser" class="hover:text-pink-500 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
